...
<body>
 <h1>Conversão de temperatura</h1>
    ...
    <form class ="form-control" method ="POST">
        ...
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Celcius</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="numero1" placeholder="Digite a temperatura">
        </div>
