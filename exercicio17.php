...
<body>
 <h1>Tabuada</h1>
    ...
    <form class ="form-control" method ="POST">
        ...
        <div class="mb-3">
            <label for="exampleFormControlInput1" class="form-label">Digite um número de 1 a 10:</label>
            <input type="text" class="form-control" id="exampleFormControlInput1" name="tabuada" placeholder="Digite o número">
        </div>
